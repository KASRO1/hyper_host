            ...
            <div class="container other_page contacts">
                  <div class="left">
                    ...
                    <div class="form">
                        ...
                        <input type="text" placeholder="Ваш e-mail адрес" id="email">
                        <input type="text" placeholder="Номер телефона" id="tel">
                        <textarea placeholder="Опишите вашу проблему" id="text"></textarea>
                        <p id="err" style="text-align: center"></p>
                        <button id="send">Отправить</button>
                    </div>
                  </div>
                  <div class="right">
                    <p class="ftext">Hyper Hosting SRL <br>
                        IDNO 1022608001174</p>
                        <div class="item">
                            <div class="icon">
                            ...
                            <div>
                                <p class="text"> 
                                    ...
                                    MD-4304, ул. Штефан чел маре 3А, офис 14
                                    г. Каушаны, Республика Молдова
                                </p>
                            </div>
                        </div> 
                        <div class="items">
                            <div class="item">
                                ...
                                <div>
                                    <p class="text"> 
                                        <span>Для частных лиц:</span> <br>
                                        <a href="tel:+37322123196">+373 22 123196</a>  
                                    </p>
                                </div>
                            </div> 
                            <div class="item">
                            ...
                            <div class="item">
                                ...
                                <div> 
                                    <p class="text"> 
                                        <span>Фин. вопросы:</span><br>
                                        <a href="mailto:fin@hyper.hosting">fin@hyper.hosting</a>
                                    </p>
                                </div>
                            </div> 
                            <div class="item">
                                ...
                                <div> 
                                    <p class="text"> 
                                        <span>Запросы полиции:</span><br>
                                        <a href="mailto:police@hyper.hosting">police@hyper.hosting</a>
                                    </p>
                                </div>
                            </div>
                            <div class="item">
                                ...
                                <div> 
                                    <p class="text">  
                                        <span>Партнерство:</span><br>
                                        <a href="mailto:partners@hyper.hosting">partners@hyper.hosting</a>
                                    </p>
                                </div>
                            </div> 
                        </div>

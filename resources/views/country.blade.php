...
<main>
                <div class="container">
                    <div class="slider country">
                        <div class="slide">
                            <div>
                                <p class="title">
                                    Аренда VPS/VDS в {{__($data_center->key_title_translate)}}, <br>
                                    <span>город {{$data_center->city}}
                                ...
                                <a href="#tarifs" class="btn"> <p>Смотреть тарифы</p> <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M5 12H19M19 12L13 18M19 12L13 6" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></div> </a>
                            </div>
            ...
            <section class="servers_countries">
                <div class="container">
                    <p class="title">Сервера в других странах</p>
                    <div class="items">
            ...
            <section class="infos">
                <h2><span>Идеальный хостинг</span> для вас</h2>
                <div class="container">
                    <div class="item">
            ...
            <section class="faq">
                <div class="container">
                    <h2 class="title"><span>Часто задаваемые</span> вопросы</h2>
                    <div class="items">
                   ...
                   <a href="#" class="more">Служба поддержки</a>
                </div>
            </section>

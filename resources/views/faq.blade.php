...
<main class="other_page">
                <div class="container">
                    <h1><span>ЧАСТО</span> ЗАДАВАЕМЫЕ ВОПРОСЫ</h1>
                </div>
            </main>
                   ...
                   <div class="left items">
                    ...
                    @endphp
                        ...
                        <div class="item">
                            ...
                            <div class="head">
                                <p>{{$i}}. {!! __($faq->key_title_translate)  !!}</p>
                            </div>
                            <p class="text" style="display: none;">
                                {!!   nl2br(__($faq->key_title_translate)) !!}
                            </p>
                        </div>
                        @endforeach
                    @endforeach
                   ...
                   <div class="right">
                        <div class="supp">
                            ...
                            <p>
                                ...
                                либо появились трудности в использовании
                                нашего сервиса или продукта вы
                                можете обратиться в нашу Службу
                                поддержки которая готова помочь вам в
                                решении любого вопроса в любое <br>
                                время суток 24/7.
                            </p>
                            <a href="{{route('contacts')}}" class="btn">Служба поддержки</a>
                        </div>
                   </div>
            </div>
